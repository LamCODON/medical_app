...
const AddPrescription = () => {
    ...
    const names = prescriptionList.map(prescription => prescription.name || null);
    const currentName = names[0];
    console.log(prescriptionList.length > 0 ? prescriptionList[0].name : '');
    const [value, onChangeText] = useState(prescriptionList.length > 0 ? prescriptionList[0].name : '');
